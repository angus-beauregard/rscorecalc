...
def show_free_page():
    ...
    st.markdown("""
        <div style='display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;'>
            <div><a href='/' style='text-decoration:none;color:#0f5fff;font-weight:700;'>🏠 rscorecalc.com</a></div>
            <div>
                <a href='/?page=auth' target='_self'>
                    <button style='background-color:#0f5fff;color:white;border:none;padding:0.4rem 1rem;border-radius:0.5rem;cursor:pointer;font-weight:600;'>
                        Upgrade to Premium
                    </button>
                </a>
            </div>
    ...
    st.markdown(
        '<div class="subtitle">Estimate your R-Score manually — simple, fast, and accurate.</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown("""
        ...
        <p>
        This weighting means higher-credit courses affect your R-Score more.
        </p>

        <p>
        <em>The Premium version</em> adjusts for your real school difficulty (IDGZ) and group strength (ISGZ),
        supports CSV/OCR uploads, and tracks your R-Score history automatically.
        </p>
        </div>
    """, unsafe_allow_html=True)
