...
def show_free_page():
    ...
    st.markdown("""
        <div style='display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;'>
            ...
            <div>
                <button onclick="window.parent.postMessage({ type: 'page', page: 'auth' }, '*')" 
                    style='background-color:#0f5fff;color:white;border:none;padding:0.4rem 1rem;border-radius:0.5rem;cursor:pointer;font-weight:600;'>
                Upgrade to Premium
                </button>
            </div>
        </div>
